...
public:
    ...
    void rasterScan(const std::function<void(const unsigned int, const unsigned int)>& fn) const;
    Image *rasterMap(const std::function<PIXEL_TYPE *(const unsigned int, const unsigned int)>& fn) const;
    void concurrentScan(const std::function<void(const unsigned int, const unsigned int)>& fn,
