...
std::vector<uint8_t> BinaryFileIO::read(std::istream &input) const {
...
void BinaryFileIO::write(std::ostream &output, const std::vector<uint8_t> &bytes) const {
