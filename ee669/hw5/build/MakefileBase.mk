...
INC_DIR += $(CURDIR)/../../../src/lib
LIB_DIR = $(CURDIR)/../../../build/lib
APP_DIR = $(CURDIR)/../../../bin
3RD_PARTY_LIB_DIR = /usr/local/lib

CPPFLAGS = -std=$(CPP_STD) $(addprefix -I, $(INC_DIR)) -c -fPIC -pthread $(CUSTOM_CPPFLAGS)
DEBUG_CPPFLAGS = -Wall -Wextra -g -D__DEBUG
RELEASE_CPPFLAGS = -O3

CCFLAGS = -std=$(CC_STD) $(addprefix -I, $(INC_DIR)) -c -fPIC $(CUSTOM_CCFLAGS)
